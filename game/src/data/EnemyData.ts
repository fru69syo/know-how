...
export const ENEMY_DEFS: Record<EnemyType, EnemyDef> = {
  ...
  elite:       { type: 'elite',       textureKey: 'enemy_alien',   baseHp: 25,  baseXP: 50,   baseCoinDrop: 5,  scoreValue: 150,  width: 38, height: 38, sideMovement: true, sideSpeed: 55, canShoot: true, shootInterval: 2000, bulletSpeed: 260, bulletDamage: 12 },
  elite_heavy: { type: 'elite_heavy', textureKey: 'enemy_boss',    baseHp: 60,  baseXP: 100,  baseCoinDrop: 10, scoreValue: 350,  width: 50, height: 50, sideMovement: true, sideSpeed: 35, canShoot: true, shootInterval: 1200, bulletSpeed: 300, bulletDamage: 18 },
  phantom:     { type: 'phantom',     textureKey: 'enemy_drone',   baseHp: 40,  baseXP: 130,  baseCoinDrop: 15, scoreValue: 500,  width: 34, height: 34, sideMovement: true, sideSpeed: 90, canShoot: true, shootInterval: 1500, bulletSpeed: 340, bulletDamage: 22 },
  mega_boss:   { type: 'mega_boss',   textureKey: 'enemy_boss',    baseHp: 800, baseXP: 500,  baseCoinDrop: 50, scoreValue: 5000, width: 90, height: 90, sideMovement: false, sideSpeed: 0, canShoot: true, shootInterval: 2000, bulletSpeed: 300, bulletDamage: 25 },
};
