...
export const SKILL_DEFS: Record<SkillId, SkillDef> = {
  ...
  magnet:           { id:'magnet',           name:'磁力フィールド',         description:'アイテム吸引範囲拡大',       icon:'icon_coin', maxLevel:3, rarity:'common',    applyLevel:(s,lv)=>{ s.magnetRadius=s.baseMagnetRadius+lv*40; } },
  ...
  vampire:          { id:'vampire',          name:'吸血',                   description:'撃破時HP+2%回復/Lv',        icon:'icon_heart',maxLevel:3, rarity:'rare',     applyLevel:(s,lv)=>{ s.vampireHealPct=s.baseVampireHealPct+lv*0.02; } },
  auto_heal:        { id:'auto_heal',        name:'自動回復',               description:'10秒ごとHP+2%回復/Lv',     icon:'icon_heart',maxLevel:3, rarity:'common',    applyLevel:(s,lv)=>{ s.autoHealPct=s.baseAutoHealPct+lv*0.02; } },
